...
"""
Example of how to use AsyncIO request with openAI API. 
"""


async def send_req(client, system_message, message, output, task_number):
...
IMPORTANT: Return a valid JSON object in the following format: {format}.'''
    ...
    tasks = []
    for i in range(10):
        tasks.append(send_req(client, system_message, message, output, i + 1))
